...
IGNORE_FILES="!(content/tv/tgik/**/index.md) !(content/tv/talk/**/index.md) !(cotent/team/josh-long/_index.md)" # $IGNORE_MEMBERS" # Don't worry about TGIK/Tanzu Talk episodes for now as they scrape from YT
