...
IGNORE_FILES="!(content/tv/tgik/**/index.md) !(content/tv/talk/**/index.md) !(content/team/josh-long/_index.md) !(content/blog/josh-long/*.md)" # Don't worry about TGIK/Tanzu Talk episodes for now as they scrape from YT
