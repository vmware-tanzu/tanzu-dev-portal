...
IGNORE_FILES="!(content/team/mark-heckler/_index.md) !(content/tv/tgik/*.md) !(content/tv/talk/*.md)" # Too much spanish, don't worry about TGIK/Tanzu Talk episodes for now as they scrape from YT
