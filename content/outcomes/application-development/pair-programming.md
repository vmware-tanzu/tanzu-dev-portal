...
At VMWare Tanzu Labs, we are known for being on the cutting edge of Agile software development—some might even say extreme. One software development technique in which we believe deeply is pair programming.
...
*   Countering "hero" culture though collective code ownership 
...
*   Shared ownership of the code and product
*   Empathy building
