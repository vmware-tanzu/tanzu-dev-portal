...
## Conclusion
Well, this is the end of this coverage of the basics of REST. I suggest reading Roy Fieldings  REST [dissertation](https://www.ics.uci.edu/~fielding/pubs/dissertation/rest_arch_style.htm) if you haven't already. If you’d like to start building your own REST APIs and are a Spring developer, be sure to check out [Building a REST API with Spring Boot](/guides/spring/spring-build-api) to see these principles in action! 
