...
After your release is successfully created, you'll see an output like this with the name, namespace, status, etc. The `NOTES` section has specific information about our instal–that's because it's generated by helm using a template too.
