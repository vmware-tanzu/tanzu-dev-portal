...
Finally, in a couple of the examples, you'll be pushing container images to Docker Hub, so create a secret that can be used by Tekton to log in to Docker Hub. Substitute the placeholder values with your own:
