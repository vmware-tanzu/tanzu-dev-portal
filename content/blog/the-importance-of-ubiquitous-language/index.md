...
Let's use an example to illustrate what we are talking about.  Say that our team is writing a shopping application and our product manager have a user interview with someone from the business and write a single story that says something along the lines of:
